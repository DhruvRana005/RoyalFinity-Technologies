...
const Services = () => {
  const services = [
    ...
    {
      title: 'AI & Automation',
      desc: '👉 Step into the future with AI.',
      points: [
        'AI Chatbots',
        'Automation Systems',
        'Analytics & Insights',
    ...
    },
    {
      ...
      points: ['Smart AI Chatbots & Virtual Assistants',
    ...
    },
    {
      ...
      points: ['Keyword Research & On-Page SEO',
    ...
    },
    {
      ...
      points: ['Search Ads (Google Search Campaigns)',
    ...
    },
    {
      ...
      points: ['Blog Writing & SEO Content',
  ...
  return (
    <div className="relative overflow-hidden bg-[#050816] text-white">
      <div className="mx-auto max-w-7xl mt-30 text-center">

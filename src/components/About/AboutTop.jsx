...
export default function AboutTop() {
  return (
    <section className="relative overflow-hidden bg-warm-yellow min-h-screen text-center text-white">
      ...
      <div className="max-w-5xl mx-auto px-6 py-16 md:py-28 flex flex-col items-center justify-center">
        <div>
          ...
          <p className="mt-10 text-lg md:text-xl leading-8 text-white/80 max-w-3xl mx-auto">

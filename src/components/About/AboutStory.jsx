...
const AboutStory = () => {
    return (
        <div className="min-h-screen w-full overflow-hidden bg-gray-900 px-4 py-16 text-center">
            <div className="mx-auto flex max-w-4xl flex-col items-center">
                ...
                <h1 className="max-w-4xl text-4xl font-semibold leading-[1.15] tracking-tight text-white md:text-6xl">
                ...
                <p className="mt-10 max-w-4xl text-lg leading-9 text-white md:text-[1.35rem] md:leading-[2.35rem]">
